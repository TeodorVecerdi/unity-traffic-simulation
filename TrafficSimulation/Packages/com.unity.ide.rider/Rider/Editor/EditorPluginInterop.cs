    ...
    public static string LogPath
    {
      get
      {
        try
        {
          ...
          var logPathField = type.GetField("LogPath", BindingFlags.NonPublic | BindingFlags.Static);
          if (logPathField == null) return null;
          return logPathField.GetValue(null) as string;
        }
        catch (Exception)
        {
